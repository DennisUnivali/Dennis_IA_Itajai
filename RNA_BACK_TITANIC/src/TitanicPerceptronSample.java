	...
	public static void main(String[] args) {
		...
		try {
			...
			while((line=bfr.readLine())!=null) {
				...
				if(count<500) {
					trainingSet.addRow(new DataSetRow(new double[] { pclass,sex,age,sibSp,parch,fare }, new double[] {survive}));
				}else {
					testSet.addRow(new DataSetRow(new double[] { pclass,sex,age,sibSp,parch,fare }, new double[] {survive}));	
				}
				count++;
		...
		MultiLayerPerceptron myMlPerceptron = new MultiLayerPerceptron(TransferFunctionType.TANH, 6, 16,32, 1);
